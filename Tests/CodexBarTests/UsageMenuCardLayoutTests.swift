...
struct UsageMenuCardLayoutTests {
    ...
    @Test
    func `metric line presentation keeps selected percent and reset in title row`() {
        ...
        #expect(presentation.titleText == "Weekly 69%")
    ...
    @Test
    func `metric title follows selected percent style`() {
        ...
        #expect(leftMetric.linePresentation(title: leftMetric.title).titleText == "Weekly 69%")
